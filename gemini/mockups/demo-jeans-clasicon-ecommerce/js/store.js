(function () {
  ...
  var STORAGE_KEY = "jeans-clasicon-cart-v1";
  ...
  var PRODUCT_SEEDS = [
    { name: "Jean clásico azul oscuro caballero", type: "clasico", category: "hombre", price: 80, mayor: 80 },
    { name: "Jean clásico azul claro", type: "clasico", category: "hombre", price: 80, mayor: 80 },
    { name: "Jean gris acid wash", type: "clasico", category: "hombre", price: 85, mayor: 80 },
    { name: "Pantalón licra clásico", type: "licra", category: "hombre", price: 80, mayor: 80 },
    { name: "Jean recto fabricante directo", type: "clasico", category: "hombre", price: 80, mayor: 75 },
    { name: "Jean clásico tiro medio", type: "clasico", category: "hombre", price: 82, mayor: 80 },
    { name: "Jean índigo clásico", type: "clasico", category: "hombre", price: 80, mayor: 80 },
    { name: "Jean azul deslavado caballero", type: "clasico", category: "hombre", price: 80, mayor: 80 },
    { name: "Pantalón licra azul", type: "licra", category: "hombre", price: 82, mayor: 80 },
    { name: "Pantalón licra gris", type: "licra", category: "hombre", price: 82, mayor: 80 },
    { name: "Jean pack mayor x3", type: "mayor", category: "hombre", price: 240, mayor: 210 },
    { name: "Jean clásico negro", type: "clasico", category: "hombre", price: 85, mayor: 80 },
  ];

  var EDITIONS = ["Talla 30", "Talla 32", "Talla 34", "Talla 36", "Talla 38", "Talla 40"];
  ...
  function buildCatalog() {
    ...
    for (var i = 1; i <= 36; i += 1) {
      ...
      products.push({
        ...
        desc: "Jean clásico para hombre · JEANS CLASICON · Fabricantes directos en Feria Barrio Lindo, Santa Cruz. Precio referencial Bs 80 al mayor/menor según TikTok — confirmá stock por WhatsApp.",
      });
    }
    return products;
  }
  ...
  function initProductPage() {
    ...
    document.title = product.name + " — JEANS CLASICON";
  ...
  function initCheckoutPage() {
    ...
    form.addEventListener("submit", function (e) {
      ...
      var msg =
        "Hola JEANS CLASICON, quiero confirmar mi pedido:%0A%0A" +
        details +
        "%0A%0ATotal: " +
        formatBs(cartSubtotal()) +
        "%0A%0ANombre: " +
      ...
      window.open("https://wa.me/59175552043?text=" + msg, "_blank", "noopener,noreferrer");
    });
