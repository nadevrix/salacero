  ...
  window.ChanezLayout = {
    mount: function (page) {
      ...
      root.innerHTML =
        ...
        "🇧🇴 Santa Cruz · 📍 Feria Barrio Lindo · 👖 Fabricantes directos · " +
        '<a href="https://wa.me/59175552043" target="_blank" rel="noopener">WhatsApp 75552043</a>' +
        "</div></div>" +
        '<nav class="navbar navbar-expand-lg navbar-dark navbar-chanez sticky-top">' +
        '<div class="container-fluid px-3 px-lg-4">' +
        '<a class="navbar-brand brand-lockup d-flex align-items-center gap-2" href="./index.html" aria-label="JEANS CLASICON inicio">' +
        '<img class="brand-avatar" src="./assets/logo-jeans-clasicon.svg" alt="" width="48" height="48">' +
        '<span class="brand-name d-none d-md-block"><strong>JEANS CLASICON</strong><small class="d-block text-muted-brand">@jeans.clasicon · Fabricantes directos</small></span>' +
        "</a>" +
        ...
        '<li class="nav-item"><a class="btn btn-chanez btn-sm ms-lg-2" href="https://wa.me/59175552043" target="_blank" rel="noopener">Pedir por WhatsApp</a></li>' +
        "</ul></div></div></nav>" +
